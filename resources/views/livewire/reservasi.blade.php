<div class="max-w-md mx-auto bg-gradient-to-b from-gray-50 to-white min-h-screen flex flex-col">
    ...
    <div class="bg-gradient-to-r from-yellow-300 to-yellow-200 text-black p-4 rounded-b-[40px] pb-16 relative shadow-lg">
        ...
        <div class="flex flex-col items-center">
            ...
            <div class="w-24 h-24 bg-black rounded-full mb-3 overflow-hidden border-4 border-white shadow-lg transform transition-transform hover:scale-105 duration-300">
                <img src="{{ asset('icon/8link yellow (no bg).png') }}" alt="Profile" class="w-full h-full object-cover">
            </div>
